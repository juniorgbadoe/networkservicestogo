...
const services = [
  'Cablage Ethernet Cat6 et Cat6a',
  'Fibre optique, baie de brassage et test de lien',
  'Etiquetage, plans et documentation de recette',
];

const benefits = [
  'Infrastructure lisible et maintenable',
  'Connectivite fiable pour postes, serveurs et Wi-Fi',
  'Base solide pour les evolutions reseau',
];

export default function Cablage() {
  return (
    <section className="min-h-screen bg-gradient-to-br from-white via-[var(--gray-50)] to-white pt-28 pb-20 dark:from-[var(--gray-900)] dark:via-[var(--gray-900)] dark:to-[var(--gray-800)]">
      <div className="container">
        <nav className="text-sm text-[var(--gray-500)] mb-8 dark:text-slate-300">
          ...
          <span className="mx-2">/</span>
          <span className="text-[var(--gray-700)] dark:text-slate-100">Cablage reseau</span>
        </nav>

        <div className="grid lg:grid-cols-[1.1fr,0.9fr] gap-12 items-start">
          <div>
            <div className="w-14 h-14 rounded-lg bg-gradient-to-br from-[#FFB800] to-[#00D4D4] text-white flex items-center justify-center mb-6 shadow-lg">
              <Cable size={26} />
            </div>
            ...
            <p className="text-lg text-[var(--gray-600)] leading-relaxed max-w-3xl dark:text-slate-300">
              Nous concevons et realisons des infrastructures de cablage propres, testees et documentees pour garantir
              une connectivite rapide, fiable et facile a maintenir.
            </p>
          ...
          <div className="grid gap-5">
            ...
            <div className="rounded-lg border border-[var(--gray-200)] bg-white p-6 shadow-sm dark:bg-white/[0.05] dark:border-white/10">
              <h2 className="text-xl font-bold mb-4 text-[var(--secondary)] dark:text-slate-100">Qualite et conformite</h2>
              <ul className="space-y-3 text-[var(--gray-700)] dark:text-slate-300">
                {benefits.map((item) => (
                  <li key={item} className="flex gap-3">
