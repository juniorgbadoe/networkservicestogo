...
const services = [
  'Architecture LAN, WAN et Wi-Fi',
  'Segmentation VLAN, qualite de service et securite',
  'Supervision, documentation et transfert de competences',
];

const benefits = [
  'Connexions stables entre equipes et ressources',
  'Reseau pret pour la croissance de votre organisation',
  'Exploitation plus simple pour vos equipes internes',
];
    ...
    <section className="min-h-screen bg-gradient-to-br from-white via-[var(--gray-50)] to-white pt-28 pb-20 dark:from-[var(--gray-900)] dark:via-[var(--gray-900)] dark:to-[var(--gray-800)]">
      <div className="container">
        <nav className="text-sm text-[var(--gray-500)] mb-8 dark:text-slate-300">
          ...
          <span className="mx-2">/</span>
          <span className="text-[var(--gray-700)] dark:text-slate-100">Deploiement reseau</span>
        </nav>

        <div className="grid lg:grid-cols-[1.1fr,0.9fr] gap-12 items-start">
          <div>
            <div className="w-14 h-14 rounded-lg bg-gradient-to-br from-[#0055FF] to-[#3377FF] text-white flex items-center justify-center mb-6 shadow-lg">
              <Network size={26} />
            </div>
            <h1 className="text-4xl md:text-5xl font-extrabold mb-5 text-[var(--secondary)] dark:text-slate-100">
              Deploiement des reseaux d'entreprise
            </h1>
            <p className="text-lg text-[var(--gray-600)] leading-relaxed max-w-3xl dark:text-slate-300">
              Nous deploions des reseaux performants, securises et evolutifs, de l'etude technique a la mise en service,
              avec une documentation exploitable et des standards professionnels.
            </p>
          ...
          <div className="grid gap-5">
            <div className="rounded-lg border border-[var(--gray-200)] bg-white p-6 shadow-sm dark:bg-white/[0.05] dark:border-white/10">
              <h2 className="text-xl font-bold mb-4 text-[var(--secondary)] dark:text-slate-100">Competences cles</h2>
            ...
            <div className="rounded-lg border border-[var(--gray-200)] bg-white p-6 shadow-sm dark:bg-white/[0.05] dark:border-white/10">
              <h2 className="text-xl font-bold mb-4 text-[var(--secondary)] dark:text-slate-100">Livrables</h2>
              <ul className="space-y-3 text-[var(--gray-700)] dark:text-slate-300">
                {benefits.map((item) => (
                  <li key={item} className="flex gap-3">
